...
constructor(
  ...
  private fun makeWaffleObject(name: String, user: PublicKey): TransactionInstruction {
    ...
    val waffleKey =
        PublicKey.findProgramAddress(
            ...
            PublicKey("9SxNGCu5h971eJDaqfU3bdBW1WRtTVqYA6pQ3yKN3kHh")
        )
  ...
  @Serializable class Args_createWaffle(val name: String)
        ...
        try {
          ...
          when (transferResult) {
            is TransactionResult.Success -> {
              try {
                val transferId =
                    sendTransactionRepository.sendTransaction(transferResult.payload).getOrThrow()
